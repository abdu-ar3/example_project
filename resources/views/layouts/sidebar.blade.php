        ...
        >
            <div class="sidenav-header">
                ...
                >
                    <img
                        ...
                        alt="main_logo"
                    />
                    <span class="ms-1 font-weight-bold">Example Project</span>
                </a>
            </div>
            ...
            >
                <ul class="navbar-nav">
                    ...
                    <!-- Page Admin -->
                    <li class="nav-item">
                        <a class="nav-link" href="{{route('test_admin.index')}}">
                            <div
                                class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center"
                            >
                                <svg
                            ...
                            <span class="nav-link-text ms-1">Page Admin</span>
                        </a>
                    </li>
                    @endcan
                    ...
                    <!-- Page User -->
                    <li class="nav-item">
                        <a class="nav-link" href="{{route('test_user.index')}}">
